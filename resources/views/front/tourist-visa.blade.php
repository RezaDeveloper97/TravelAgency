            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p> همان‌طور که قبلا در اینستاگرام ما رویت کردین ، إلمان های گرفتن ویزای توریستی مستقل داشتن حداقل یکی از موارد زیر میباشد.</p>      
                        <ul>
                            <li>تعداد سفرهای متعدد شما ( به خصوص‌ شنگن اگر برای کشور های غیر اروپایی اقدام‌ میکنید )</li>
                            <li>دارا بودن شغل و پوزیشن مناسب</li>
                            <li>دلایل برگشت</li>
                            <li>داشتن دعوت نامه معتبر</li>
                            <li>داشتن حساب بانکی حداقلی و منظم با توجه به کشور مقصد</li>
