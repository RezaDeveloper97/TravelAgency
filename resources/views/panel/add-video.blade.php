...
<main>
    ...
    <div class="container-xl px-4 mt-n10 is-rtl">
        <form action="{{ route('api.add-video') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gx-4">
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <input required class="form-control" name="title" id="postTitleInput" type="text" placeholder="" />
                        </div>
                    </div>
                    ...
                    <div class="card card-header-actions mb-4">
                        ...
                        <div class="card-body">
                            <textarea required class="form-control" name="description" id="exampleFormControlTextarea1" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <input class="form-control" name="video_link" id="postTitleInput" dir="ltr" type="text" >
                        </div>
                    </div>
