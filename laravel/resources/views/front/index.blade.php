            ...
            <div class="row align-items-end">
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1>تحصیل در انگلستان، آمریکا، کانادا و استرالیا سلام</h1>
                        <p>جذب و آماده سازی کارشناسان با استعداد برای بیش از 25 سال. ما یک پیشنهاد ارزش منحصر به فرد برای هر دو ارائه می دهیم. هرکسی که دوست ندارد یا دنبال نمی کند.</p>
                        <div class="hero-btn">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content single-section ">
                    ...
                    <h2>ما از ابتدا تا انتها از مهاجرت شما حمایت می کنیم</h2>
